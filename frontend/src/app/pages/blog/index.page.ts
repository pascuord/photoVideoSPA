      ...
      <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div class="relative aspect-video overflow-hidden">
            ...
            <div
              class="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/60 via-black/0 to-transparent"
            ></div>
          ...
          <div class="p-4">
            <h2
              class="font-semibold leading-snug line-clamp-2 group-hover:text-white transition-colors"
            >
              {{ p.title }}
            </h2>
