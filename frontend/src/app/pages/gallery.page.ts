  ...
  template: `
    <section class="mx-auto max-w-screen-xl px-4 py-8" appAntiDownload>
      ...
      @if (loading()) {
        ...
        @if (error()) {
          <div class="mb-4 rounded border border-red-500/20 bg-red-950/30 p-3 text-red-300">
            {{ error() }}
             ...
             hover:-translate-y-0.5 hover:shadow-xl"
              ...
              >
                <div class="relative w-full aspect-[4/3] overflow-hidden">
                  ...
                  <img
                    *ngIf="m.thumbnailUrl && m.thumbnailUrl !== m.url && !isLoaded(m.id)"
                    [src]="m.thumbnailUrl"
                    [alt]="m.title"
                ...
                <div class="absolute inset-x-3 bottom-3 flex items-center justify-between">
                  ...
                  <div class="pointer-events-auto">
                    @defer (on viewport) {
                      <app-like-button [contentType]="'image'" [contentId]="m.id"></app-like-button>
                    } @placeholder {
                      <div
