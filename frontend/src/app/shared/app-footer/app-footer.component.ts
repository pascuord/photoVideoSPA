      ...
      <div class="py-10 md:py-12 grid gap-10 text-center place-items-center">
        ...
        >
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              <li>
                <a [href]="'mailto:' + email" class="hover:text-white/90" rel="noopener">
                  {{ email }}
                </a>
              </li>
        ...
        <section class="space-y-3 max-w-xl">
          ...
          <p class="text-sm text-neutral-400">Angular · Tailwind CSS · Supabase · Vite</p>
        </section>
      </div>

      <div class="border-t border-white/10">
        <div class="py-5 flex flex-col items-center justify-center gap-3 text-center">
          <p class="text-xs text-neutral-500">
            © {{ year }} {{ name }}. Todos los derechos reservados.
          </p>
          <a href="#top" class="text-xs hover:text-white/90 inline-flex items-center gap-2">
...
export class AppFooterComponent {
  ...
  @Input() bio = 'Construyo interfaces limpias y accesibles, con foco en rendimiento y UX.';
