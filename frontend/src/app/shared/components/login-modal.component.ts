import { Component, EventEmitter, Output, inject, signal, PLATFORM_ID } from '@angular/core';
    ...
    >
      ...
      >
        ...
        <form (submit)="sendMagicLink($event)" class="space-y-3">
          ...
          <p class="text-xs">Revisa tu email y abre el enlace para iniciar sesión.</p>

          <p *ngIf="sent()" class="text-sm text-emerald-700">✅ Te enviamos un enlace de acceso.</p>
        ...
        <div class="mt-4 flex justify-end">
          <button (click)="onClose()" class="text-sm text-neutral-100 hover:text-neutral-300">
            Cerrar
          </button>
        </div>
      </div>
